...
export const SETTINGS = [
  ...
  {
    id: "rank-and-file-fantasy",
    name: "Rank and File Fantasy",
    blurb: "Warbands drawn from rank-and-flank miniature games: RuneWars, Kings of War, Conquest: The Last Argument of Kings, and A Song of Ice & Fire. Each army from its starter set, statted up as Dragon Rampant.",
    detachments: [...RUNEWARS, ...KOW, ...CONQUEST, ...ASOIAF],
  },
  {
    id: "open-order-games",
    name: "Open Order Games",
    blurb: "Warbands from games where units fight as loose individuals rather than formed blocks: Age of Sigmar and Eldfall Chronicles.",
    detachments: [...AOS, ...ELDFALL],
  },
  {
    id: "3d-printed-armies",
    name: "3D Printed Armies",
    blurb: "Warbands from Artisan Guild and Titan Forge — popular 3D-printable miniature ranges for fantasy battles.",
    comingSoon: true,
    detachments: [],
  },
];
