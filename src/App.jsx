...
import {
  UNIT_TYPES, XENO_RULES, SPECIAL_RULES,
  BUDGET_PRESETS, UNIT_BY_ID, XENO_BY_ID,
  SPELL_COLOURS,
} from "./data.js";
...
const ICON_CATS = [
  ...
  { id: "combat",   name: "Arms & Shields",    short: "Arms",     col: "var(--sage)" },
  { id: "beasts",   name: "Beasts & Monsters", short: "Beasts",   col: "var(--iris)" },
  { id: "skulls",   name: "Skulls & Death",    short: "Skulls",   col: "var(--rust)" },
  { id: "factions", name: "Faction Marks",     short: "Factions", col: "var(--brass)" },
  { id: "arcane",   name: "Arcane & Mythic",   short: "Arcane",   col: "var(--iris)" },
];
const ICON_SETTINGS = [
  { id: "all",      name: "All settings", short: "All",      col: null },
  { id: "medieval", name: "Medieval",     short: "Medieval", col: "var(--ink-2)" },
  { id: "mythic",   name: "Mythic",       short: "Mythic",   col: "var(--sage)" },
  { id: "dark",     name: "Dark Fantasy", short: "Dark",     col: "#8A3A3A" },
  { id: "folk",     name: "Folk & Fable", short: "Folk",     col: "var(--brass)" },
  { id: "lore",     name: "Lore",         short: "Lore",     col: "var(--iris)" },
];
const EMBLEM_META = {
  /* combat */
  "crossed-swords":                      { cat: "combat",   setting: "medieval" },
  "spartan-helmet":                      { cat: "combat",   setting: "medieval" },
  "eagle-emblem":                        { cat: "combat",   setting: "medieval" },
  "checked-shield":                      { cat: "combat",   setting: "medieval" },
  "mailed-fist":                         { cat: "combat",   setting: "medieval" },
  "centurion-helmet":                    { cat: "combat",   setting: "medieval" },
  "visored-helm":                        { cat: "combat",   setting: "medieval" },
  "barbute":                             { cat: "combat",   setting: "medieval" },
  "knight-banner":                       { cat: "combat",   setting: "medieval" },
  "mounted-knight":                      { cat: "combat",   setting: "medieval" },
  "ms-swords":                           { cat: "combat",   setting: "medieval",  name: "Crossed Swords" },
  "mdi-knight":                          { cat: "combat",   setting: "medieval",  name: "Chess Knight" },
  "ic-shieldmoon":                       { cat: "combat",   setting: "mythic",    name: "Shield Moon" },
  "game-icons-warlord-helmet":           { cat: "combat",   setting: "medieval",  name: "Warlord Helmet" },
  "material-symbols-chess-knight-sharp": { cat: "combat",   setting: "medieval",  name: "Knight" },
  "black-knight-helm":                   { cat: "combat",   setting: "dark",      name: "Black Knight Helm" },
  "sword-altar":                         { cat: "combat",   setting: "mythic",    name: "Sword Altar" },
  ...
  /* beasts */
  "wolf-head":                           { cat: "beasts",   setting: "folk" },
  "dragon-head":                         { cat: "beasts",   setting: "mythic" },
  "bear-face":                           { cat: "beasts",   setting: "folk" },
  "double-dragon":                       { cat: "beasts",   setting: "mythic" },
  "dragon-spiral":                       { cat: "beasts",   setting: "mythic" },
  "wolf-howl":                           { cat: "beasts",   setting: "folk" },
  "hydra":                               { cat: "beasts",   setting: "mythic" },
  "tiger-head":                          { cat: "beasts",   setting: "folk" },
  "raven":                               { cat: "beasts",   setting: "dark" },
  "spider-alt":                          { cat: "beasts",   setting: "dark" },
  "monster-grasp":                       { cat: "beasts",   setting: "dark" },
  "fa-dragon":                           { cat: "beasts",   setting: "mythic",    name: "Dragon" },
  "spiked-dragon-head":                  { cat: "beasts",   setting: "mythic",    name: "Spiked Dragon Head" },
  "dragon-shield":                       { cat: "beasts",   setting: "mythic",    name: "Dragon Shield" },
  "sea-dragon":                          { cat: "beasts",   setting: "mythic",    name: "Sea Dragon" },
  "icon-park-solid-dragon-zodiac":       { cat: "beasts",   setting: "mythic",    name: "Dragon Zodiac" },
  "goblin":                              { cat: "beasts",   setting: "folk",      name: "Goblin" },
  "orc-head":                            { cat: "beasts",   setting: "folk",      name: "Orc Head" },
  "metal-golem-head":                    { cat: "beasts",   setting: "mythic",    name: "Golem Head" },
  /* skulls */
  "skull-crossed-bones":                 { cat: "skulls",   setting: "dark" },
  "death-skull":                         { cat: "skulls",   setting: "dark" },
  "crowned-skull":                       { cat: "skulls",   setting: "dark" },
  "fa-skull":                            { cat: "skulls",   setting: "dark",      name: "Skull" },
  /* factions */
  "elf-woman":                           { cat: "factions", setting: "mythic",    name: "Elf Woman" },
  ...
  "angel-wings":                         { cat: "arcane",   setting: "mythic" },
  "flame":                               { cat: "arcane",   setting: "mythic" },
  "magic-palm":                          { cat: "arcane",   setting: "mythic",    name: "Magic Palm" },
  "magic-lamp":                          { cat: "arcane",   setting: "folk",      name: "Magic Lamp" },
  "magic-gate":                          { cat: "arcane",   setting: "mythic",    name: "Magic Gate" },
  "warlock-eye":                         { cat: "arcane",   setting: "dark",      name: "Warlock Eye" },
  "wizard-staff":                        { cat: "arcane",   setting: "mythic",    name: "Wizard Staff" },
  "wizard-hat":                          { cat: "arcane",   setting: "folk",      name: "Wizard Hat" },
  "fa-khanda":                           { cat: "arcane",   setting: "mythic",    name: "Khanda" },
  "elven-castle":                        { cat: "arcane",   setting: "mythic",    name: "Elven Castle" },
  "medieval-pavilion":                   { cat: "arcane",   setting: "medieval",  name: "Medieval Pavilion" },
  "medieval-gate":                       { cat: "arcane",   setting: "medieval",  name: "Medieval Gate" },
};
...
const DETACH_ICON_LIST_META = DETACH_ICON_LIST.map((item) => {
  ...
  return { ...item, cat: m.cat || "arcane", setting: m.setting || "medieval", name: m.name || _idToName(item.id) };
});
...
const UNIT_ABBR = {
  "elite-riders": "ER", "heavy-riders": "HR", "light-riders": "LR",
  "greater-warbeasts": "GW", "lesser-warbeasts": "LW",
  "elite-foot": "EF", "heavy-foot": "HF", "light-foot": "LF", "bellicose-foot": "BF",
  "heavy-missiles": "HM", "light-missiles": "LM", "scouts": "SC", "ravenous-hordes": "RH",
};
...
const MountedIco = mk(giMountedKnight), BeastIco = mk(giDragon);
const CATS = [
  { id: "foot", label: "Foot", Icon: Infantry },
  { id: "mounted", label: "Mounted", Icon: MountedIco },
  { id: "beast", label: "Warbeasts", Icon: BeastIco },
];
...
/* a one-line readout of every Spell a colour of magic grants */
const spellColourText = (col) => (col.spells || []).map((s) => `${s.name} (${s.difficulty}): ${s.effect}`).join("  •  ");
const optCost = (o) => o.cost || 0;
function xenoCost(rule, val) {
  if (rule.tiers) return rule.tiers[typeof val === "number" ? val : 0].cost;
  return rule.cost || 0;
}
/* like xenoCost, but resolves the Large upgrade's armour-dependent cost for a unit */
function xenoDisplayCost(x, u) {
  if (x.costByArmour) {
    const t = UNIT_BY_ID[u.typeId];
    const arm = Number(deriveStats(u, t).prof.arm) || Number(t.prof.arm) || 1;
    return arm >= 4 ? 3 : arm === 3 ? 2 : 1;
  }
  return xenoCost(x, u.xenos[x.id]);
}
/* display name for a xeno rule, spelling out the chosen tier: the spellcaster class
...
function xenoLabel(x, u) {
  ...
  if (x.id === "spellcaster") {
    const colours = u.colours || [];
    return `Spellcaster (${tier.label}${colours.length ? `: ${colours.join(", ")}` : ""})`;
  }
  return `${x.name} (${tier.label})`;
}
...
function unitSP(u) {
  ...
  for (const xid of Object.keys(u.xenos)) {
    const r = XENO_BY_ID[xid];
    if (r && r.spDelta) sp += r.spDelta;
  }
  return sp;
}
/* some unit options replace a base special rule (eg. Mounted Missiles removes
   Wild Charge and Counter-charge). the special rules a unit actually carries are
   its type's rules minus anything an active option strips away. */
const OPTION_REMOVES = {
  "mounted-missiles": ["Wild Charge", "Counter-charge"],
  "drilled": ["Wild Charge"],
  "flame-spore": ["Wild Charge"],
...
function hasShoot(u, t) {
  const s = deriveStats(u, t).prof.sho;
  return !!s && s !== "–" && s !== "-" && s !== "n/a";
}
const hasUpg = (u, id) => !!(u && u.xenos && id in u.xenos);
...
function eligibleXenos(t, u) {
  ...
  return XENO_RULES.filter((x) => {
    ...
    let ok = true;
    if (av.type === "except") ok = !av.list.includes(t.id);
    else if (av.type === "only") ok = av.list.includes(t.id);
    if (!ok && x.orHasUpgrade && x.orHasUpgrade.some((id) => hasUpg(u, id))) ok = true;
    if (!ok) return false;
    if (x.needsShoot && !hasShoot(u, t)) return false;
    if (x.leaderOnly && !(u && u.isCmd)) return false;
    if (x.nonLeaderOnly && u && u.isCmd) return false;
    if (x.notHasUpgrade && x.notHasUpgrade.some((id) => hasUpg(u, id))) return false;
    return true;
  });
}
const isSpellcasterRule = (x) => x.id === "spellcaster";
function sanitize(u) {
  const t = UNIT_BY_ID[u.typeId];
  ...
  // drop any fantastical the unit is no longer eligible for (eg. after losing a
  // Shoot Value or being un-designated as Leader), and coerce tier indexes.
  const elig = new Set(eligibleXenos(t, { ...u, options }).map((x) => x.id));
  const xenos = { ...u.xenos };
  for (const id of Object.keys(xenos)) {
    if (!elig.has(id)) { delete xenos[id]; continue; }
    const x = XENO_BY_ID[id];
    if (x && x.tiers && typeof xenos[id] !== "number") xenos[id] = 0;
  }
  // keep chosen colours of magic within what the Spellcaster Level allows
  let colours = u.colours || [];
  if (!("spellcaster" in xenos)) {
    colours = [];
  } else {
    const pr = XENO_BY_ID["spellcaster"];
    const ti = typeof xenos.spellcaster === "number" ? xenos.spellcaster : 0;
    const lim = pr.tiers[ti].powers;
    if (colours.length > lim) colours = colours.slice(0, lim);
  }
  return { ...u, options, xenos, colours };
}
function validate(roster, budget, freeplay) {
  ...
  const leaders = roster.filter((u) => u.isCmd).length;
  const [minU, maxU] = budget >= 36 ? [6, 18] : [4, 12];
  if (used > budget) issues.push({ lvl: "err", msg: `Over budget by ${used - budget} points.` });
  if (count > 0) {
    if (leaders === 0) issues.push({ lvl: "err", msg: "No Leader. Designate one unit as your Leader." });
    if (leaders > 1) issues.push({ lvl: "err", msg: `${leaders} Leaders. Only one is allowed.` });
    if (count < minU) issues.push({ lvl: "err", msg: `Too few units. A ${budget}-point Warband needs ${minU} to ${maxU} units.` });
    if (count > maxU) issues.push({ lvl: "err", msg: `Too many units. A ${budget}-point Warband allows ${minU} to ${maxU} units.` });
    // per-unit cost, always 1 to 10
    roster.forEach((u, i) => {
      const p = unitPoints(u);
      if (p > 10) issues.push({ lvl: "err", msg: `${unitDisplayName(u, i)} costs ${p} points; no unit may cost more than 10.` });
      if (p < 1) issues.push({ lvl: "err", msg: `${unitDisplayName(u, i)} costs ${p} points; every unit must cost at least 1.` });
    });
    // colours of magic still to choose
    roster.forEach((u, i) => {
      if ("spellcaster" in u.xenos) {
        const ti = typeof u.xenos.spellcaster === "number" ? u.xenos.spellcaster : 0;
        const lim = XENO_BY_ID.spellcaster.tiers[ti].powers;
        const left = lim - (u.colours || []).length;
        if (left > 0) issues.push({ lvl: "err", msg: `${unitDisplayName(u, i)} has ${left} colour${left === 1 ? "" : "s"} of magic left to choose.` });
      }
    });
    // some fantasticals are capped: one per full 24 points, or one per Warband
    const cap24 = Math.max(1, Math.floor(budget / 24));
    XENO_RULES.forEach((x) => {
      const n = roster.filter((u) => x.id in u.xenos).length;
      if (x.limitPer24 && n > cap24 * x.limitPer24) issues.push({ lvl: "err", msg: `${n} units have ${x.name}; the limit is ${cap24 * x.limitPer24} (one per full 24 points).` });
      if (x.limitPerWarband && n > x.limitPerWarband) issues.push({ lvl: "err", msg: `${n} units have ${x.name}; only ${x.limitPerWarband} is allowed per Warband.` });
    });
  }
  ...
  det.units.forEach((e) => {
    ...
    for (let c = 0; c < n; c++) {
      ...
      roster.push(sanitize({
        ...
        isCmd: !!e.isCmd, options, xenos: { ...(e.xenos || {}) },
        colours: e.colours || [], custom: [], notes: e.notes || "",
      }));
    }
  });
...
function savePlay(listId, st) {
  try { localStorage.setItem(`drb.play.${listId}`, JSON.stringify(st)); } catch { /* ignore */ }
}
...
function encodeShare(list) {
  const payload = {
    ...
    r: list.roster.map((u) => ({
      ...
      o: u.options, x: u.xenos,
      p: (u.colours && u.colours.length) ? u.colours : undefined,
      cu: (u.custom && u.custom.length) ? u.custom : undefined,
      no: u.notes || undefined,
    })),
  };
...
function decodeShare(str) {
  try {
    ...
    return {
      name: o.n || "", budget: o.b || 30, description: o.d || "",
      ...
      roster: (o.r || []).filter((u) => UNIT_BY_ID[u.t]).map((u) => sanitize({
        ...
        options: u.o || {}, xenos: u.x || {}, colours: u.p || [],
        custom: u.cu || [], notes: u.no || "",
      })),
    };
  } catch { return null; }
}
...
function orderFrom(act, key) {
  const { val, free } = parseAct(act[key]);
  return val === "n/a" ? null : { val, free };
}
function orderCell(t, key) { return orderFrom(t.act, key); }
...
const STAT_MODS = {
  // unit options that add or change a ranged attack
  "mounted-missiles": { act: { sho: "6+" }, prof: { sho: "5+ / 12\"" } },
  "mounted-missiles-add": { act: { sho: "6+" }, prof: { sho: "5+ / 12\"" } },
  "flame-spore": { act: { sho: "6+" }, prof: { sho: "5+ / 12\"" } },
  "missiles": { act: { sho: "6+" }, prof: { sho: "5+ / 18\"" } },
  "short-missiles": { act: { sho: "6+" }, prof: { sho: "5+ / 6\"" } },
  "mixed-weapons": { act: { sho: "6+" }, prof: { sho: "5+ / 12\"" } },
  "short-range": { prof: { sho: "5+ / 6\"" } },
  "sharpshooters": { prof: { sho: "4+ / 18\"" } },
  "weighty-projectiles": { prof: { sho: "4+ / 12\"" } },
  // unit options that change melee, defence, armour or move
  "offensive": { prof: { atk: "4+" } },
  "cunning": { prof: { def: "5+" } },
  "motivated": { act: { mov: "6+" } },
  "armoured": { prof: { arm: 3 } },
  "chariots": { prof: { arm: 4 } },
  // fantastical upgrades that shift a shown stat
  "fast": { movDelta: 2 },
  "slow": { movDelta: -2 },
  "fearful": { couWorsen: 1 },
  "drums-and-flags": { couImprove: 1 },
  "longer-range": { rngDelta: 4 },
  "undead": { act: { cou: "0+" } },
};
...
function deriveStats(u, t) {
  ...
  ids.forEach((id) => {
    ...
    if (m.rngDelta) {
      const { main, range } = splitRange(prof.sho);
      const n = parseInt(range, 10);
      if (!Number.isNaN(n)) { prof.sho = `${main} / ${n + m.rngDelta}"`; changed.add("prof:sho"); }
    }
...
function StatTable({ t, sp, u, hint = true, spBubbles = false }) {
  ...
  return (
    <div className="xr-stt">
      ...
      {STAT_ROWS.map((row) => {
        const o = row.order ? orderFrom(d.act, row.key) : null;
  ...
  return (
    <footer className="game-info-footer">
      <div className="gif-inner">
        <span className="gif-title">Dragon Rampant 2e</span>
        ...
        <span className="gif-sep">|</span>
        <a href="https://www.ospreypublishing.com/us/dragon-rampant-second-edition-9781472858672/" target="_blank" rel="noopener">Buy the game</a>
        <span className="gif-sep">|</span>
        <span className="gif-builder">Warband builder by <a className="warlore-mark" href="https://jetwong.neocities.org" target="_blank" rel="noopener" title="WarLore">War<span className="wl-lore">Lore</span></a></span>
        <span className="gif-sep">|</span>
  ...
  return (
    <nav className="xr-rail" aria-label="Views">
      <div className="xr-rail-nav">
        {items.map((it) => (
          <button key={it.v} className={`xr-rail-btn ${view === it.v ? "on" : ""}`} title={it.v === "home" ? "All warbands" : it.label}
  ...
  return (
    <div className="xr-modal-backdrop" onClick={onClose}>
      <div className="xr-modal xr-modal-tall xr-modal-wide" role="dialog" aria-modal="true" aria-label="Rules reference" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="xr-modal-foot">
          <span className="xr-modal-count">Dragon Rampant 2e, Osprey Games</span>
  ...
  return (
    <div className="xr-budget" role="group" aria-label="Game size">
      {BUDGET_PRESETS.map((b) => (
        <button key={b} className={`xr-budget-chip ${isPreset && budget === b ? "on" : ""} ${b === 30 ? "std" : ""}`}
          title={b === 30 ? "Standard game size, the default" : `${b}-point game`}
          onClick={() => { setCustomOpen(false); onChange(b); }}>
          <span className="xr-budget-num">{b}</span>
          {b === 30 && <em className="xr-budget-rec">default</em>}
        </button>
      ))}
...
function NewArmyModal({ onCreate, onClose, collections = [] }) {
  ...
  return (
    <div className="xr-modal-backdrop" onClick={onClose}>
      <div className="xr-modal xr-modal-narrow" role="dialog" aria-modal="true" aria-label="New warband" onClick={(e) => e.stopPropagation()}>
        <div className="xr-modal-head">
          <span className="xr-modal-title"><Plus size={22} /> New warband</span>
          <button className="xr-iconbtn" onClick={onClose} aria-label="Close"><XIc size={20} /></button>
        </div>
        <div className="xr-modal-body">
        ...
        <div className="xr-modal-foot">
          <button className="xr-btn primary" onClick={create}><Plus size={17} /> Create warband</button>
        </div>
      </div>
...
function LoadPresetModal({ onLoad, onClose }) {
  ...
  return (
    <div className="xr-modal-backdrop" onClick={onClose}>
      <div className="xr-modal xr-modal-tall xr-modal-wide" role="dialog" aria-modal="true" aria-label="Load a preset warband" onClick={(e) => e.stopPropagation()}>
        <div className="xr-modal-head">
        ...
        <div className="xr-modal-body">
          ...
          {setting.comingSoon || setting.detachments.length === 0 ? (
            ...
            <div className="xr-preset-grid">
              {setting.detachments.map((d, i) => (
                <button className="xr-preset-card" key={i} onClick={() => onLoad(d, setting)}>
    ...
    return (
      <div className="xr-list-card" key={l.id}>
        <button className="xr-list-open" onClick={() => onOpen(l.id)}>
          ...
          <span className="xr-list-name">{l.name || "Untitled warband"}</span>
      ...
      <main className="xr-home-body">
        {arr.length > 0 && (
          <div className="xr-home-bar">
            <h2 className="xr-home-h">Warbands <em>{arr.length}</em></h2>
            <div className="xr-home-bar-btns">
              <button className="xr-btn primary" onClick={() => setCreating(true)}><Plus size={20} /> New warband</button>
              {PRESET_SETTINGS.length > 0 && (
                <button className="xr-btn" onClick={() => setLoading(true)} title="Start from a ready-made Warband out of the rulebook"><Book size={19} /> Load a preset</button>
              )}
            </div>
          </div>
        )}
        {arr.length === 0 ? (
          <div className="xr-home-welcome">
            <span className="xr-home-welcome-badge"><BeastIco size={48} /></span>
            <h2>Build your first warband</h2>
            <p>Start from scratch, or load a ready-made Warband from the rulebook.</p>
            <div className="xr-home-welcome-btns">
              <button className="xr-btn primary" onClick={() => setCreating(true)}><Plus size={19} /> New warband</button>
              {PRESET_SETTINGS.length > 0 && (
...
/* which abilities actually GRANT another named rule (not merely mention it), so
   the print sheet can pull in that rule's definition. none in Dragon Rampant yet. */
const RULE_GRANTS = {};
...
const COMMANDER_RULES = [
  "Your Leader is part of a unit and may not join a different unit during the game, and is the last model in the unit to die.",
  "Once per turn, you may reroll one failed Move, Attack or Shoot test within 12\" of the Leader's model, unless the Leader is Battered.",
  "Units within 12\" of the Leader's model add 1 to their Courage tests, unless the Leader is Battered.",
  "The Leader is free and does not increase the unit's cost or Strength Points. Buy fantastical upgrades to craft their Leader traits.",
].join("\n");
  ...
  return (
    <section className="xr-panel" aria-label="Unit editor">
      <div className="xr-panel-head">
        ...
        <button className={`xr-btn small xr-cmd-btn ${u.isCmd ? "gold" : ""}`} onClick={() => { if (!u.isCmd) dispatch({ type: "cmd", key: u.key }); }} title={COMMANDER_RULES} aria-label={u.isCmd ? "Leader" : "Make Leader"}>
          <Crown size={17} /> {u.isCmd ? "Leader" : "Make Leader"}
        </button>
      </div>
        ...
        <div className="xr-panel-col xr-col-abil">
          <div className="xr-abil">
            <div className="xr-abil-head">
              ...
              <button className="xr-btn small xr-manage" onClick={onBuyAbilities} title="Add or remove options and fantastical upgrades"><Plus size={16} /> Manage abilities</button>
            </div>
            {boughtOpts.length + boughtXenos.length + custom.length > 0 ? (
              <div className="xr-abil-list">
                ...
                {boughtXenos.map((x) => (
                  <AbilityItem key={x.id} name={`${x.name}${x.tiers ? ` (${x.tiers[typeof u.xenos[x.id] === "number" ? u.xenos[x.id] : 0].label})` : ""}`} cost={xenoDisplayCost(x, u)} text={x.text} tone="xeno" kind="Fantastical" />
                ))}
                {(u.colours || []).map((name) => {
                  const col = SPELL_COLOURS.find((p) => p.name === name);
                  return col ? <AbilityItem key={`col-${name}`} name={`${col.name} magic`} tone="psy" kind="Colour" text={spellColourText(col)} /> : null;
                })}
                {custom.map((c) => (
          ...
          {u.isCmd && (
            <div className="xr-cmdcard">
              <div className="xr-cmdcard-h">
                <span className="xr-cmdcard-t"><Crown size={15} /> Your Leader</span>
              </div>
              <p className="xr-cmdcard-trait">Your Leader is free: no extra points, no Strength Points. Units within 12" of the Leader add 1 to their Courage tests, and once a turn you may reroll a failed Move, Attack or Shoot within 12". Give them character with fantastical upgrades; a few are Leader-only.</p>
            </div>
          )}
        </div>
      </div>
...
/* which fantastical upgrades open a config step when selected */
...
function configSummary(x, u) {
  if (x.tiers) {
    ...
    if (x.id === "spellcaster") { const n = (u.colours || []).length; s += `, ${n} of ${t.powers} colour${t.powers === 1 ? "" : "s"} chosen`; }
    return s;
  }
  return "";
}

/* a fantastical upgrade row: toggle to buy, and if it needs setup, a Configure button */
function XenoRow({ x, u, dispatch, onConfigure }) {
  ...
  const toggle = () => {
    ...
    if (!sel && cfg) onConfigure(x.id, x.id === "spellcaster" ? "class" : "tier");
  };
  return (
    <OptionRow active={sel} name={x.name} cost={xenoDisplayCost(x, u)} showLore
      text={x.text}
      onToggle={toggle}>
      {sel && cfg && (
        <div className="xr-xcfg">
          <span className="xr-xcfg-cur">{configSummary(x, u)}</span>
          <button className="xr-btn small" onClick={() => onConfigure(x.id, x.id === "spellcaster" ? "powers" : "tier")}>
...
/* the spellcaster tab is just its rule row; setup happens in the config modal */
function SpellcasterTab({ u, rules, dispatch, onConfigure }) {
  return (
    <div className="xr-sc-tab">
      {rules.map((x) => <XenoRow key={x.id} x={x} u={u} dispatch={dispatch} onConfigure={onConfigure} />)}
    </div>
  );
}

/* focused setup for a configurable upgrade: tier cards (Cleric, Slayer), or the
   Spellcaster level-then-colours flow. */
function XenoConfigModal({ rule, u, dispatch, onClose, initialStep }) {
  ...
  const isSpellcaster = rule.id === "spellcaster";
  const limit = isSpellcaster ? rule.tiers[tierIdx].powers : 0;
  const chosen = u.colours || [];
  const title = isSpellcaster ? (step === "powers" ? `${rule.tiers[tierIdx].label} colours` : "Spellcaster Level") : `${rule.name}`;
  ...
  return (
    <div className="xr-modal-backdrop" onClick={onClose}>
      <div className="xr-modal xr-modal-tall" role="dialog" aria-modal="true" aria-label={`Configure ${rule.name}`} onClick={(e) => e.stopPropagation()}>
        <div className="xr-modal-head">
          {isSpellcaster && step === "powers" && <button className="xr-iconbtn" onClick={() => setStep("class")} aria-label="Back to level"><Back size={20} /></button>}
        ...
        <div className="xr-modal-body">
          {isSpellcaster && step === "class" && tierCards((i) => { dispatch({ type: "tier", key: u.key, xid: rule.id, i }); setStep("powers"); })}

          {isSpellcaster && step === "powers" && (
            <div className="xr-sc-colours">
              <div className="xr-sc-h">
                <h4>Choose colours of magic</h4>
                <span className={`xr-sc-count ${chosen.length >= limit ? "full" : ""}`}>{chosen.length} of {limit} chosen</span>
              </div>
              <div className="xr-colours">
                {SPELL_COLOURS.map((col) => {
                  const on = chosen.includes(col.name);
                  const atLimit = chosen.length >= limit && !on;
                  return (
                    <button key={col.name} className={`xr-colour c-${col.name.toLowerCase()} ${on ? "on" : ""}`} disabled={atLimit}
                      onClick={() => dispatch({ type: "colour", key: u.key, colour: col.name })}
                      title={on ? "Remove this colour" : atLimit ? "This Spellcaster Level has no free colour slots" : "Add this colour"}>
                      <span className="xr-colour-h">
                        <span className="xr-colour-dot" aria-hidden="true" />
                        <span className="xr-colour-name">{col.name}</span>
                        <span className="xr-colour-check">{on && <Check size={15} />}</span>
                      </span>
                      <span className="xr-colour-spells">
                        {col.spells.map((s) => (
                          <span className="xr-colour-spell" key={s.name}><b>{s.name}</b> <em>{s.difficulty}</em> {s.effect}</span>
                        ))}
                      </span>
                    </button>
                  );
          ...
          {!isSpellcaster && tierCards((i) => { dispatch({ type: "tier", key: u.key, xid: rule.id, i }); onClose(); })}
        </div>
        <div className="xr-modal-foot">
          <button className="xr-btn primary" onClick={onClose}><Check size={17} /> Done</button>
        </div>
...
function AbilitiesModal({ u, dispatch, onClose }) {
  ...
  const elig = useMemo(() => eligibleXenos(t, u), [t, u]);
  const eligXeno = elig.filter((x) => !isSpellcasterRule(x));
  const eligPsy = elig.filter(isSpellcasterRule);
  const custom = u.custom || [];
  const tabs = [];
  if (topOpts.length) tabs.push({ id: "load", label: "Options", n: topOpts.filter((o) => u.options[o.id]).length });
  if (eligXeno.length) tabs.push({ id: "xeno", label: "Fantastical", n: eligXeno.filter((x) => x.id in u.xenos).length });
  if (eligPsy.length) tabs.push({ id: "spellcaster", label: "Spellcaster", n: eligPsy.filter((x) => x.id in u.xenos).length });
    ...
    <div className="xr-modal-backdrop" onClick={onClose}>
      <div className="xr-modal xr-modal-tall" role="dialog" aria-modal="true" aria-label="Buy abilities" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="xr-modal-body">
          ...
          {tab === "spellcaster" && <SpellcasterTab u={u} rules={eligPsy} dispatch={dispatch} onConfigure={openConfig} />}
          {tab === "custom" && (
...
function AddUnitModal({ onAdd, onClose }) {
  const [cat, setCat] = useState("foot");
  useEffect(() => {
    const onKey = (e) => { if (e.key === "Escape") onClose(); };
    window.addEventListener("keydown", onKey);
    return () => window.removeEventListener("keydown", onKey);
  ...
  return (
    <div className="xr-modal-backdrop" onClick={onClose}>
      <div className="xr-modal xr-modal-tall xr-modal-wide xr-modal-addunit" role="dialog" aria-modal="true" aria-label="Add unit" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="xr-ref-foot">
          <span className="xr-ref-note"><b>Shoot range</b> Foot Missiles 18" · Scouts, Mounted Missiles, Mixed & Flame 12" · Short Range 6"</span>
          <span className="xr-ref-note"><b>Max move</b> Light Riders &amp; Lesser Warbeasts 12" · other Mounted 10" · Bellicose, Light Foot &amp; Scouts 8" · other Foot 6"</span>
        </div>
      </div>
    </div>
  );
...
function Builder({ list, selectedKey, dispatch, updateList, onDelete }) {
  ...
  const copyList = () => {
    const lines = [`${list.name || "Untitled warband"} (${used}/${budget} pts, ${count} units)`];
    roster.forEach((u, i) => {
      const t = UNIT_BY_ID[u.typeId];
      lines.push(`${u.isCmd ? "[LEADER] " : ""}${unitDisplayName(u, i)} (${t.name}, ${unitPoints(u)} pts, ${unitSP(u)} SP)`);
      t.options.filter((o) => u.options[o.id]).forEach((o) => lines.push(`- ${o.name} (${costLabel(optCost(o))})`));
      XENO_RULES.filter((x) => x.id in u.xenos).forEach((x) => lines.push(`- ${xenoLabel(x, u)} (${costLabel(xenoDisplayCost(x, u))})`));
  ...
  return (
    <div className="xr-build">
                  ...
                  <div className="xr-settings-pop" role="dialog" aria-label="Warband settings">
                    ...
                    <div className="xr-set-field xr-set-img">
                      ...
                      <div className="xr-set-img-row">
                        <ImageUpload image={list.image} onChange={(img) => updateList({ image: img || undefined })} title="Upload a warband picture" />
                    ...
                    <button className={`xr-set-toggle ${list.freeplay ? "on" : ""}`} onClick={() => updateList({ freeplay: !list.freeplay })} aria-pressed={!!list.freeplay}>
                      ...
                      <span className="xr-set-toggle-txt"><b>Free play</b><i>Ignore composition limits (unit count, per-unit cost, one Leader).</i></span>
                    </button>
                    <button className="xr-btn small danger xr-set-delete" onClick={onDelete}><Trash size={16} /> Delete this warband</button>
                  </div>
                </>
              )}
            </div>
      ...
      <div className={`xr-build-body ${sel ? "has-sel" : ""}`}>
        <main className="xr-ulist" aria-label="Warband roster">
          {roster.length === 0 ? (
            ...
            <>
              {roster.length > 1 && (
                <div className="xr-ulist-file" role="group" aria-label="Order units">
                  ...
                  <button className="xr-file-btn" onClick={() => dispatch({ type: "sort", by: "cat" })} title="Group by type: foot, then mounted, then warbeasts">Type</button>
        ...
        <div className="xr-detail">
          {sel ? (
            <UnitPanel key={sel.key} u={sel} index={selIdx} dispatch={dispatch} onClose={() => nav("#/build")} onBuyAbilities={() => setAbilOpen(true)} factionPool={ALL_NAMES} />
          ) : (
            roster.length > 0 && (
              <div className="xr-detoverview" aria-label="Warband notes">
                <div className="xr-detoverview-head">
                  ...
                  <div className="xr-detoverview-id">
                    <h2 className="xr-detoverview-name">{list.name || "Untitled warband"}</h2>
                    <span className="xr-detoverview-meta">{used}/{budget} pts, {count} {count === 1 ? "unit" : "units"}</span>
                  </div>
                </div>
                <label className="xr-notes-l" htmlFor="det-notes">Warband notes</label>
                <textarea id="det-notes" className="xr-field-in xr-field-area xr-detoverview-notes" value={list.description || ""}
                  placeholder="Backstory, tactics, or notes for the whole warband. Shows on the list card and the print sheet."
                  onChange={(e) => updateList({ description: e.target.value })} rows={6} />
                <p className="xr-detoverview-hint"><BeastIco size={16} /> Select a unit on the left to edit it.</p>
              </div>
            )
          )}
        </div>
    ...
    <div className={`xr-printview ${opts.contrast ? "contrast" : ""} ${opts.large ? "large" : ""}`}>
      ...
      <div className="xr-print-chrome">
        ...
        <div className="xr-print-opts">
          ...
          {[["stats", "Stat table"], ["upgrades", "Options and fantastical upgrades"], ["rules", "Special rules"], ["spells", "Spells"]].map(([k, lab]) => (
      ...
      <div className="xr-sheet">
        <div className="xr-sheet-head">
          ...
          <h1 className="xr-sheet-title">{list.name || "Untitled warband"}</h1>
          <div className="xr-sheet-meta">Dragon Rampant 2e &nbsp; {used}/{budget} pts &nbsp; {count} {count === 1 ? "unit" : "units"}</div>
        </div>
  ...
  return (
    <div className="xr-play">
      ...
      <header className="xr-play-mast">
        <button className="xr-iconbtn" onClick={() => nav("#/build")} aria-label="Back to builder"><Back size={20} /></button>
        <h2 className="xr-play-h">{list.name || "Untitled warband"}</h2>
...
export default function App() {
  ...
  const dispatch = useCallback((a) => {
    switch (a.type) {
      case "add": {
        const key = uid();
        setRoster((r) => [...r, { key, typeId: a.typeId, name: "", isCmd: r.length === 0, options: {}, xenos: {}, colours: [], custom: [] }]);
        nav(`#/build/${key}`);
        break;
      }
      ...
      case "sort":
        setRoster((r) => {
          ...
          // leaders always float to the top, then the chosen order; stable otherwise
      ...
      case "xeno":
        setRoster((r) => r.map((u) => {
          ...
          else { xenos[a.xid] = rule.tiers ? 0 : true; (rule.conflicts || []).forEach((c) => delete xenos[c]); }
      ...
      case "colour":
        setRoster((r) => r.map((u) => {
          ...
          const lim = pr.tiers[ti].powers;
          let cur = u.colours || [];
          if (cur.includes(a.colour)) cur = cur.filter((n) => n !== a.colour);
          else if (cur.length < lim) cur = [...cur, a.colour];
          return { ...u, colours: cur };
        }));
        break;
      case "customAdd":
  ...
  const createList = (opts = {}) => {
    ...
    setLists((ls) => ({ ...ls, [id]: { id, name: opts.name || "", budget: opts.budget || 30, description: opts.description || "", roster: [], image: opts.image || undefined, icon, collection: opts.collection || undefined, updated: Date.now() } }));
    setCurrentId(id);
    nav("#/build");
  };
...
.xr-app{
  /* Dragon Rampant 2e livery: clean near-white pages, warm near-black ink, and the
     book's deep crimson (sampled from the rulebook at #A72C31) as the accent. */
  --paper:#FAF7F1; --paper-2:#F1ECE1; --paper-3:#E7DFD0;
  --ink:#241F1A; --ink-2:#5E564C; --ink-18:rgba(36,31,26,.16); --ink-30:rgba(36,31,26,.30);
  --cream:#FAF7F1;
  --coral:#A72C31; --coral-ink:#8A2328;
  --sage:#5C7A52; --iris:#6A4A8C; --rust:#A6631F; --brass:#9A7A1C;
  ...
  --shadow4:0 0 2px rgba(36,31,26,.12),0 2px 4px rgba(36,31,26,.16);
  --shadow8:0 0 2px rgba(36,31,26,.12),0 4px 8px rgba(36,31,26,.16);
  --shadow16:0 0 2px rgba(36,31,26,.12),0 8px 16px rgba(36,31,26,.16);
  --shadow28:0 0 8px rgba(36,31,26,.14),0 14px 28px rgba(36,31,26,.18);
  --shadow64:0 0 8px rgba(36,31,26,.14),0 32px 64px rgba(36,31,26,.20);
  /* brand accent, retinted to the rulebook crimson for text-bearing surfaces */
  --brand-green:#A72C31; --brand-blue:#7E2126; --brand-grad:linear-gradient(100deg,var(--brand-green),var(--brand-blue));
  --brand-deep:linear-gradient(100deg,#A72C31,#7E2126); --brand-deep-blue:#8A2328;
...
.xr-die.k-atk{background:#A72C3122;border-color:var(--coral-ink);}
...
.xr-stt-head{display:grid;grid-template-columns:170px 76px 1fr;gap:4px 8px;padding:0 8px 6px;border-bottom:2px solid var(--coral);font-family:var(--display);font-weight:600;letter-spacing:.02em;font-size:15.5px;color:var(--ink-2);}
...
.xr-home-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(min(280px,100%),1fr));gap:16px;}
...
.xr-firstunit:hover{background:var(--paper-3);transform:translateY(-2px);box-shadow:0 6px 16px rgba(36,31,26,.15);}
...
/* compact points readout, shown only on mobile (the rail muster is hidden there) */
...
.xr-settings-pop{position:absolute;right:0;top:calc(100% + 8px);z-index:40;width:min(320px,86vw);display:flex;flex-direction:column;gap:14px;background:var(--paper);border:2.5px solid var(--ink);border-radius:12px;box-shadow:0 12px 34px rgba(36,31,26,.26);padding:14px;animation:xr-pop .18s cubic-bezier(.2,.8,.2,1);}
...
.xr-status.err{color:var(--coral-ink);border-color:var(--coral-ink);background:#A72C3118;}
...
.xr-issue-pop{position:absolute;top:calc(100% + 8px);right:0;z-index:35;min-width:270px;max-width:380px;background:var(--paper);border:2px solid var(--ink);border-radius:12px;box-shadow:0 8px 26px rgba(36,31,26,.24);padding:12px;display:none;flex-direction:column;gap:8px;}
...
.xr-build-body{flex:1;display:grid;grid-template-columns:minmax(min(320px,100%),430px) 1fr;gap:0;align-items:start;}
...
.xr-urow:hover{background:var(--paper-3);transform:translateX(3px);box-shadow:0 3px 9px rgba(36,31,26,.12);}
...
.xr-urow-name{font-family:var(--display);font-weight:700;font-size:16px;line-height:1.15;flex:1;min-width:0;overflow-wrap:anywhere;}
...
.xr-panel-cols{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(288px,100%),1fr));gap:8px 28px;align-items:start;}
...
/* pills wrap onto more rows rather than scrolling sideways */
.xr-epicker-pscroll{display:flex;flex-wrap:wrap;gap:6px;padding-bottom:2px;}
...
.xr-epicker-tip{position:absolute;bottom:calc(100% + 6px);left:50%;transform:translateX(-50%);background:var(--ink);color:var(--cream);font:12px/1.3 var(--body);width:max-content;max-width:100%;text-align:center;overflow-wrap:anywhere;padding:4px 8px;border-radius:6px;pointer-events:none;opacity:0;transition:opacity .12s;z-index:10;}
...
/* compact d6 outcome table, for any table-shaped rule that needs one */
...
/* spellcaster colour picker */
.xr-sc-colours{margin-top:16px;border-top:2px solid var(--ink-30);padding-top:14px;}
.xr-sc-h{display:flex;align-items:center;gap:14px;margin-bottom:9px;}
.xr-sc-h h4{font-family:var(--display);font-weight:700;font-size:18px;color:var(--ink);}
.xr-sc-count{font-family:var(--mono);font-weight:700;font-size:13.5px;color:var(--ink-2);padding:3px 9px;border:1.5px solid var(--ink-30);border-radius:8px;}
.xr-sc-count.full{color:var(--iris);border-color:var(--iris);background:#6A4A8C10;}
/* spellcaster colour-of-magic picker */
.xr-colours{display:grid;grid-template-columns:repeat(auto-fill,minmax(min(240px,100%),1fr));gap:10px;}
.xr-colour{display:flex;flex-direction:column;gap:7px;text-align:left;padding:11px 12px;border:2px solid var(--ink-30);border-left-width:7px;border-radius:10px;background:var(--paper-2);transition:border-color .12s,background .12s,transform .12s;}
.xr-colour:hover:not(:disabled){transform:translateY(-1px);}
.xr-colour:disabled{opacity:.45;cursor:not-allowed;}
.xr-colour.on{background:var(--paper-3);}
.xr-colour-h{display:flex;align-items:center;gap:9px;}
.xr-colour-dot{flex:none;width:18px;height:18px;border-radius:50%;border:2px solid var(--ink);background:var(--colour,#999);}
.xr-colour-name{font-family:var(--display);font-weight:700;font-size:17px;color:var(--ink);}
.xr-colour-check{margin-left:auto;width:24px;height:24px;flex:none;display:flex;align-items:center;justify-content:center;border:2px solid var(--ink);border-radius:6px;background:var(--paper);color:var(--cream);}
.xr-colour.on .xr-colour-check{background:var(--ink);border-color:var(--ink);}
.xr-colour-spells{display:flex;flex-direction:column;gap:4px;}
.xr-colour-spell{font-family:var(--body);font-size:13px;line-height:1.35;color:var(--ink-2);}
.xr-colour-spell b{color:var(--ink);font-weight:700;}
.xr-colour-spell em{font-family:var(--mono);font-style:normal;font-weight:700;font-size:12px;color:var(--coral-ink);margin-left:2px;}
.xr-colour.c-amber{--colour:#E0A11B;border-left-color:#E0A11B;}
.xr-colour.c-crimson{--colour:#C0362C;border-left-color:#C0362C;}
.xr-colour.c-emerald{--colour:#2E7D51;border-left-color:#2E7D51;}
.xr-colour.c-indigo{--colour:#3B4C9C;border-left-color:#3B4C9C;}
.xr-colour.c-jade{--colour:#3FA88A;border-left-color:#3FA88A;}
.xr-colour.c-magenta{--colour:#B0468C;border-left-color:#B0468C;}
.xr-colour.c-saffron{--colour:#E4863A;border-left-color:#E4863A;}
.xr-colour.c-turquoise{--colour:#2C9CA8;border-left-color:#2C9CA8;}
.xr-colour.c-violet{--colour:#7A4AA0;border-left-color:#7A4AA0;}
.xr-colour.on{border-color:var(--colour);}
.xr-word-ed{font-size:.62em;color:var(--coral-ink);-webkit-text-stroke:0;text-shadow:none;vertical-align:.12em;}
.xr-pc-spell{border-left:3px solid var(--iris);}
...
.xr-cmd-tablecards{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(210px,100%),1fr));gap:10px;}
...
.xr-pick-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(min(292px,100%),1fr));gap:14px;}
.xr-ref-foot{flex:none;display:flex;flex-direction:column;gap:3px;padding:9px 20px 11px;border-top:2px solid var(--ink-30);background:var(--paper-2);}
.xr-ref-note{font-family:var(--ui);font-size:12px;line-height:1.35;color:var(--ink-2);}
.xr-ref-note b{font-family:var(--display);font-weight:700;color:var(--coral-ink);margin-right:6px;text-transform:uppercase;letter-spacing:.02em;font-size:11px;}
...
.xr-cat-card:hover{background:var(--paper-3);box-shadow:0 6px 15px rgba(36,31,26,.16);transform:translateY(-3px);}
...
/* Dragon Rampant categories: foot (sage), mounted (rust), beasts (iris) */
.xr-urow.cat-foot .xr-urow-ic{color:var(--sage);}
.xr-urow.cat-mounted .xr-urow-ic{color:var(--rust);}
.xr-urow.cat-beast .xr-urow-ic{color:var(--iris);}
.xr-urow.cat-foot{border-left-color:var(--sage);}
.xr-urow.cat-mounted{border-left-color:var(--rust);}
.xr-urow.cat-beast{border-left-color:var(--iris);}
.xr-modal-tab.cat-foot.on{background:var(--sage);border-color:var(--sage);}
.xr-modal-tab.cat-mounted.on{background:var(--rust);border-color:var(--rust);}
.xr-modal-tab.cat-beast.on{background:var(--iris);border-color:var(--iris);}
.xr-cat-card.cat-foot .xr-cat-badge{color:var(--sage);}
.xr-cat-card.cat-mounted .xr-cat-badge{color:var(--rust);}
.xr-cat-card.cat-beast .xr-cat-badge{color:var(--iris);}
.xr-cat-name{flex:1;}
...
.xr-cat-act.k-atk{border-color:var(--coral-ink);background:#A72C3114;}
...
.xr-cat-stat svg{flex:none;color:var(--coral-ink);}
...
.xr-preset-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(min(250px,100%),1fr));gap:13px;}
...
.xr-preset-lore{font-family:var(--body);font-size:14px;color:var(--ink-2);line-height:1.4;margin-top:6px;}
...
.xr-sheet{width:var(--pg-w);max-width:100%;box-sizing:border-box;margin:22px auto 56px;color:#1a1a1a;padding:var(--pg-m);box-shadow:0 4px 22px rgba(36,31,26,.22);background-color:#fff;background-image:repeating-linear-gradient(#0000 0,#0000 calc(var(--pg-h) - 2px),rgba(190,51,25,.30) calc(var(--pg-h) - 2px),rgba(190,51,25,.30) var(--pg-h));background-clip:border-box;}
...
/* print stat cards */
.xr-sheet-cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(min(310px,100%),1fr));gap:7px;margin-top:9px;align-items:start;}
...
/* keep each activation die tinted with its stat colour on the printed sheet
   (screen alpha tints wash out on paper, so give print solid colour + a bar) */
.xr-pc-stt .xr-die.k-atk{background:#f6dcdd;border-color:#A72C31;color:#5e1418;}
...
.xr-pc-stt .xr-die.free{padding-left:6px;background:#f2c9b7;border-color:#A72C31;color:#3a1206;}
...
.xr-printview.contrast .xr-pc-rules p{font-weight:500;}
.xr-printview.contrast .xr-pc-nested{border-left-color:#000;}
...
.xr-printview.contrast .xr-pc-stt .xr-stt-head{border-color:#000;color:#000;}
.xr-printview.contrast .xr-bar,.xr-printview.contrast .xr-pc-accent{-webkit-print-color-adjust:exact;print-color-adjust:exact;}
...
.xr-play-grid{flex:1;display:grid;grid-template-columns:repeat(auto-fill,minmax(min(310px,100%),1fr));gap:16px;padding:20px clamp(14px,3vw,30px) 50px;align-content:start;}
...
.xr-pcard-prof svg{flex:none;color:var(--coral-ink);}
...
.xr-pcard.sup{background:#A72C311E;}
...
.xr-abil-item:hover{transform:translateY(-1px);box-shadow:0 3px 9px rgba(36,31,26,.1);}
...
@media(max-width:880px){
  ...
  /* print preview: the base rule's minmax(min(310px,100%),1fr) columns are wider than
...
/* ---------- reflow: no view scrolls sideways (320px and up) ---------- */
.xr-list-name,.xr-list-cmd,.xr-pc-name,.xr-pcard-name,.xr-play-h,.xr-detoverview-name{overflow-wrap:anywhere;min-width:0;}
.xr-list-cmd{flex-wrap:wrap;}
@media(max-width:880px){
  .xr-sheet-cards{grid-template-columns:minmax(0,1fr);}
}
@media(max-width:480px){
  .xr-word{white-space:normal;}
  .xr-stt-head,.xr-stt-row{grid-template-columns:minmax(0,1fr) 88px 96px;}
  .xr-stt-stat{min-width:0;overflow-wrap:anywhere;}
  .xr-stt-cell{white-space:normal;flex-wrap:wrap;}
}
/* ---------- @media print ---------- */
@media print{
